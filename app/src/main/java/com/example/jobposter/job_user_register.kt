...
import com.example.jobposter.databinding.ActivityJobUserRegisterBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.FirebaseDatabase

class job_user_register : AppCompatActivity() {

    //view binding
    private lateinit var binding: ActivityJobUserRegisterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityJobUserRegisterBinding.inflate(layoutInflater)
        ...
        binding.tvAccountLogin.setOnClickListener{
            ...
            startActivity(Intent(this@job_user_register, job_user_login::class.java))
    }
    ...
    private fun setUpdateInfo() {
        ...
        ref.child(uid!!)
            ...
            .addOnSuccessListener {
                ...
                startActivity(Intent(this, job_user_login::class.java))
                finish()
            }
